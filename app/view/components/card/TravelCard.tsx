        ...
        <View style={styles.container}>
            ...
            <View style={styles.row}>
                <View style={styles.bottonInfo}>
                    <Ionicons name="car-outline" color={Colors.placeholderText} size={18}/>
                    <Text>Suzuki Express</Text>
                </View>
                
                <View style={styles.bottonInfo}>
                    <MaterialCommunityIcons name="seatbelt" color={Colors.placeholderText} size={18}/>
                    <Text>2/4 Lugares Ocupados</Text>
                </View>
            </View>
        </View>
    )
