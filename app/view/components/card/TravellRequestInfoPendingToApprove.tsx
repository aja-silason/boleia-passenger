    ...
    return (
        <View style={styles.mainContent}>
            ...
            <View style={[styles.modalbuttonaction, {flexDirection: "column"}]}>
                <BehaviorButton onPress={props.accept} isLoading isSuccess={false} text="Cancelar pedido" />
                <Button onPress={props.decline} isLoading isPrimary text="Ver detalhes do Pedido" />
            </View>
        </View>
    )
}
