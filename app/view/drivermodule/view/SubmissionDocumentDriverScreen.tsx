...
import { DocumentItem, useSubmetDocuments } from "../infra/hooks/useSubmetDocuments";
import { Button } from "./components/button/Button";

export default function DocumentSubmissionScreen() {
    const {handlePickImage, handleSubmitAll, isSubmitting, documents} = useSubmetDocuments();
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                <View style={styles.infoBox}>
                    ...
                    <Text style={styles.infoTitle}>Fotografe os seus Documentos</Text>
                    <Text style={styles.infoSubtitle}>
                        Para ativar a sua conta, envie fotos nítidas da frente e do verso de cada documento listado abaixo.
                    </Text>
                </View>
