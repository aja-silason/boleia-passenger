...
export const OTPRecoveryPasswordDriverScreen = () => {
    ...
    const route = useRoute<RouteProp<RootStackParamList, "optrecovery">>();
        ...
        <View style={style.mainContainer}>
            ...
            <View style={style.container}>
                ...
                <View style={style.countionContent}>
                    ...
                    <LinkButton onPress={onRetryRequest} text="Reenviar" isPrimary/>
                </View>
